...
public class ChatDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.profilechat);
        ...
        Picasso.get().load(profilepic).placeholder(R.drawable.ic_avatar).into(imageView);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (editchat.getText().toString().isEmpty()) {
                    Toast.makeText(ChatDetailActivity.this, "blank message can not be sent", Toast.LENGTH_SHORT).show();
                ...
                database.getReference().child("chats").child(recieveroom).push().setValue(model)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
    ...
    public String encrypt(String data, Key privateKey) {
        ...
        return Base64.getEncoder().encodeToString(encoded);   //return encoded string
